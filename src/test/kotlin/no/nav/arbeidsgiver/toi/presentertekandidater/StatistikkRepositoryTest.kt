...
internal class StatistikkRepositoryTest {
    ...
    fun `Tell antall kandidater`() {
        ...
        val kandidat1 = kandidatlisteRepository.lagre(lagKandidat(kandidatlisteId = kandidatliste1.id!!, aktørId = "aktør1"))
        val kandidat2 = kandidatlisteRepository.lagre(lagKandidat(kandidatlisteId = kandidatliste2.id!!, aktørId = "aktør2"))
        val kandidat3 = kandidatlisteRepository.lagre(lagKandidat(kandidatlisteId = kandidatliste3.id!!, aktørId = "aktør3"))
